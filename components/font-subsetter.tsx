...
export default function FontSubsetter({ presets }: FontSubsetterProps) {
  ...
  const [addedPresets, setAddedPresets] = useState<PresetState>(() => buildPresetState(presets))
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-20">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <FileUploadArea onFontUpload={handleFontUpload} uploadedFont={uploadedFont} />
            </div>
              ...
              >
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <CharacterInput value={characters} onChange={handleCharacterChange} />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-bg/60 border border-line/50 rounded-md p-6 space-y-4 cursor-default pointer-events-none select-none">
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-fg-secondary font-mono font-medium">{characters.length} 字符</p>
                    </div>
                  </div>
                  {status !== 'idle' && (
                    <div className="h-px bg-line opacity-25" />
